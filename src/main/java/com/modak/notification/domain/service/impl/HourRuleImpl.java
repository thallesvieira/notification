...
/* This class is specific to implement the rules regarding hour.
 * Extends of the abstract class and implement the interface.
 */
@Service
public class HourRuleImpl extends NotificationRule implements INotificationRule {
    ...
    public LocalDateTime getFinalDate() {
        return LocalDateTime.now().withMinute(59).withSecond(59);
    }
}
